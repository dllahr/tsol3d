...
export default function beta_D_glucose() {};

var logger = log4javascript.getLogger("tsol3dmolLogger");


//basic build function is how the rendering is done
beta_D_glucose.build = function(viewerDivId, buttonsDivId, adminDivId, pdbUrl) {
...
//  defaults.elementColors['P'] = 0xced676;
    ...
    $.ajax({url: pdbUrl, success: function(data) {
        logger.trace('beta_D_glucose.build retrieved pdb data:  ' + data.substring(0,100));
        ...
        swapViewer.setView([0.021,0.0277,-0.1745,130.1769,0.1371,-0.1608,0.194,0.958]);
